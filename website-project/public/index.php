...
error_log("DEBUG ROUTING: Request: " . $_SERVER['REQUEST_URI'] . " | Base: " . $basePath . " | RouterURI: " . $requestUri);
...
try {
    ...
    while (ob_get_level())
        ob_end_clean(); // Clear buffer to ensure valid JSON
