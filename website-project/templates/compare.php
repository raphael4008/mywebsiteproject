<header class="bg-primary text-white py-5 text-center"
    style="background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('{{ basePath }}/images/d.jpg') center/cover;">
    <div class="container">
...
<script type="module">
    ...
    import { getCompareList, removeFromCompare } from '{{ basePath }}/js/compare-manager.js';
    import { showNotification, formatCurrency } from '{{ basePath }}/js/utils.js';
    ...
    async function loadComparison() {
        ...
        if (ids.length === 0) {
            compareContainer.innerHTML = '<p class="text-center w-100">You have not selected any properties to compare. <a href="listings">Browse listings</a>.</p>';
            return;
        }
